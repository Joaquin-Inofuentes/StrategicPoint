...
**528 aserciones (`Check`) en 5 archivos.**
...
| `HeadlessTestRunner.Fases8a12.cs` | 1546 | 2 | 147 | RunPhase8, RunPhase9 |
| `HeadlessTestRunner.cs` | 4195 | 7 | 121 | RunPhase1, RunPhase2, RunPhase3, RunPhase4, RunPhase5, RunPhase6 |
...
## Archivos de logica sin una sola asercion (82)
