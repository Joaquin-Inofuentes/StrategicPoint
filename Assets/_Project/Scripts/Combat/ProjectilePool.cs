...
namespace SP.Combat
{
    ...
    public class ProjectilePool : MonoBehaviour
    {
        ...
        public Projectile Spawn(Vector3 position, Vector3 direction, int shooterId, TeamId shooterTeam, int damage, Color? color = null)
        {
            if (pool == null) Bootstrap();
            var p = pool.Get();
            p.Configure(this, position, direction, shooterId, shooterTeam, damage, color);
            return p;
        }
